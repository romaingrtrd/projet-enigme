    ...
    <div class="h-full w-full  flex flex-col justify-center items-center">
        <div class="h-[350px] w-[600px] bg-[url('/assets/img/logout-box.png')] bg-contain bg-no-repeat flex justify-evenly items-center">
            <div class="h-36 w-36 flex flex-col justify-center items-center">
                <div class="h-[60px] w-[60px] bg-[url('/assets/img/switch-user.png')] bg-contain bg-no-repeat cursor-pointer"></div>
        ...
        <div class="scenario h-[110px] w-[1200px] mt-[100px] px-2 flex justify-center items-center rounded-xl border-2 border-white">
            <p class="text-white text-shadow text-center">Bientôt la fin de la journée ! Il est actuellement 17h et tu finis le travail à 18h. Nous avons été très content de toi sur cette journée. On te laisse préparer ta journée de demain pour mieux anticiper et tu pourras te déconnecter puis boire cette bière tant attendue à la maison ;)</p>
        </div>
    </div>
    <div class="absolute bottom-3 right-3"><input id="heure" value="17:00" class=" w-[60px] text-[20px] mb-[7px] tracking-wider mr-[20px] text-center font-semibold text-white" type="text"></div>
</body>
<script>
    function NextStep() {
